...
@Service
public class ResultsPrinter implements IResultsPrinter {

    public Table printResultsAuthorBooks(List<AuthorBooksCounting> list) {
    ...
    public Table printResultsLibrary(List<Library> list) {
